  ...
  return (
    <>
      ...
      <div className="disclaimer px-5 mt-6 text-black mx-4">
        <h1 className="text-center py-10 font-bold"> DISCLAIMER </h1>
        Last updated: 2022-11-01
        <br />
        <br />
        <h2 className="font-medium">WEBSITE DISCLAIMER</h2>
        <br />
        ...
        OWN RISK.
        <br />
        <h2 className="font-medium">EXTERNAL LINKS DISCLAIMER</h2>
        <br />
        ...
        <br />
        <h2 className="font-medium">PROFESSIONAL DISCLAIMER</h2>
        <br />
        ...
        <br />
        <h2 className="font-medium">TESTIMONIALS DISCLAIMER</h2>
        <br />
        ...
        <br />
        <h2 className="font-medium">YOUR INDIVIDUAL RESULTS MAY VARY.</h2>
        <br />
        ...
        <br />
        <h2 className="font-medium">ERRORS AND OMISSIONS DISCLAIMER</h2>
        <br />
        ...
        <br />
        <h2 className="font-medium">LOGOS AND TRADEMARKS DISCLAIMER</h2>
        <br />
