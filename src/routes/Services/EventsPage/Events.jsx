    ...
    <div className="bg-white">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-4xl">
          <h1 className="font-bold mb-6 font-TuskerGrotesk tracking-wider uppercase">
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-primary font-bold tracking-[0.2em] uppercase  mb-4 block">VIZAG'S PREMIER EVENT PLANNERS</span>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {stats.map((stat, i) => (
                <div key={i} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                  <p className="font-bold text-primary mb-1">{stat.value}</p>
      ...
      <section className="py-24 px-4 bg-white" id="services">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-bold mb-4 text-gray-900">Our Expertise</h2>
                    ...
                    <ul className="space-y-3 mt-6 border-t border-gray-200/60 pt-6">
                      {categoryGroup.links.map((subLink, subIdx) => (
                        <li key={subIdx}>
                          <Link
                            to={subLink.path}
                            className="flex items-center gap-2.5 text-gray-600 hover:text-primary transition-colors  font-semibold group/link"
                          >
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-bold mb-8 font-TuskerGrotesk tracking-widest uppercase">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href={`tel:${GlobalData.company.companyPhone}`} className="flex items-center gap-3 text-white font-bold  hover:scale-105 transition-transform">
