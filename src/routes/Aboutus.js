    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative h-[60vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          <h1 className="text-[28px] md:text-[45px] font-bold mb-6 tracking-tight animate-fade-in-up">
            Transforming Visions into <span className="text-primary">Memorable Experiences</span>
          </h1>
          <p className="text-[14px] md:text-[18px] opacity-90 leading-relaxed font-light">
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-4 py-1 bg-primary/10 text-primary rounded-full text-[14px] font-bold uppercase tracking-widest">
              Who We Are
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="p-4 bg-gray-50 rounded-xl border-l-4 border-primary">
                ...
                <div className="text-[14px] text-gray-500 uppercase tracking-wider">Events Managed</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border-l-4 border-primary">
                <div className="text-[30px] font-bold text-gray-900">100+</div>
                <div className="text-[14px] text-gray-500 uppercase tracking-wider">Brands Transformed</div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[28px] md:text-[45px] font-bold mb-6 text-gray-900">What We Do</h2>
            <p className="text-[14px] md:text-[18px] text-gray-600">We offer a wide range of services designed to meet all your event and marketing needs under one roof.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-[28px] md:text-[45px] font-bold mb-4 text-gray-900">Event Management</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-[28px] md:text-[45px] font-bold mb-4 text-gray-900">Digital Marketing</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-primary rounded-full mr-3"></span>
                  SEO & Social Media
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-[28px] md:text-[45px] font-bold mb-4 text-gray-900">Branding</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-primary rounded-full mr-3"></span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 space-y-4">
              ...
              <h4 className="text-[28px] md:text-[45px] font-bold text-gray-900">Creative Excellence</h4>
              <p className="text-[14px] md:text-[18px] text-gray-500">Unique ideas that make your event or brand stand out from the crowd.</p>
            </div>
            <div className="text-center p-6 space-y-4">
              <img src={OntimeDelivery} alt="Solutions" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="text-[28px] md:text-[45px] font-bold text-gray-900">End-to-End Solutions</h4>
              <p className="text-[14px] md:text-[18px] text-gray-500">Everything under one roof, from concept to final execution.</p>
            </div>
            <div className="text-center p-6 space-y-4">
              <img src={TimeManage} alt="Team" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="text-[28px] md:text-[45px] font-bold text-gray-900">Experienced Team</h4>
              <p className="text-[14px] md:text-[18px] text-gray-500">Skilled professionals with deep industry expertise and passion.</p>
            </div>
            <div className="text-center p-6 space-y-4">
              <img src={HiringModel} alt="Client-Centric" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="text-[28px] md:text-[45px] font-bold text-gray-900">Client-Centric</h4>
              <p className="text-[14px] md:text-[18px] text-gray-500">Your vision is our priority. We listen, plan, and deliver as promised.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-yellow-400/10 text-yellow-700 rounded-full text-[14px] font-bold mb-6">
                <span className="flex">
                  {[...Array(5)].map((_, i) => (
              ...
              <h2 className="text-[28px] md:text-[45px] font-black text-gray-900 mb-6 tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative group">
                ...
                <p className="text-[14px] md:text-[18px] text-gray-700 leading-relaxed mb-6 italic">"{testimonial.text}"</p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-[28px] md:text-[45px] font-bold text-gray-900">{testimonial.author}</h4>
                    <p className="text-[14px] md:text-[18px] text-gray-400">{testimonial.time}</p>
                  </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-[14px] md:text-[18px] text-gray-400 flex items-center justify-center gap-2">
      ...
      <section className="py-20 bg-primary px-4 text-center text-gray-900">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="text-[28px] md:text-[45px] font-black uppercase tracking-tighter">Let’s Create Something Amazing</h2>
          <p className="text-[14px] md:text-[18px] font-medium opacity-80">Whether you are planning a once-in-a-lifetime event or looking to grow your business, Leor Media is here to make it happen.</p>
