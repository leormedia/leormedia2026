import {
  EventHeroCover,
  CorporateEventsImg,
  EntertainmentEventsImg,
  PromotionalEventsImg,
  ExhibitionTradeImg,
  ReligiousTraditionalImg,
  CorporateMeetingsImg,
  ConferencesSeminarsImg,
  ProductLaunchImg,
  AwardFunctionsImg,
  TeamOutingsImg,
  AnnualDayImg,
  EmployeeEngagementImg,
  CelebrityManagementImg,
  LiveConcertsImg,
  DjNightsImg,
  FashionShowsImg,
  CulturalEventsImg,
...
export const EventsCompany = {
  ...
  subtitle:
    "Vizag's premier event management partner. We create moments that last a lifetime, from grand corporate events to cultural festivals.",
  coverImage: {
    src: EventHeroCover,
  ...
  section2: {
    ...
    description:
      "Leor Media is a full-service event management agency. We specialize in planning, designing, and executing events of all scales with a focus on creativity, quality, and excellence.",
  },
  services: [
    {
    ...
    },
    {
      ...
      path: "/services/events/entertainment-events",
      icon: faStar,
      description: "Concerts, celebrity management, and live shows.",
    },
    {
      title: "Promotional Events",
      path: "/services/events/promotional-events",
      icon: faBullseye,
      description: "Strategic brand activations and promotions.",
    },
    {
      title: "Exhibition & Trade Shows",
      path: "/services/events/exhibition-and-trade-shows",
      icon: faDraftingCompass,
      description: "Creative exhibition stalls and trade shows.",
    },
    {
      title: "Religious & Traditional Events",
      path: "/services/events/religious-and-traditional-events",
      icon: faScroll,
      description: "Cultural and religious event planning.",
    },
  ],
};
  ...
  services: [
    {
      ...
      description:
        "We help identify the perfect venue that aligns with your business objectives, audience size, and brand image. From conference halls to premium meeting spaces, we handle everything from setup to execution.",
      icon: faBriefcase,
    },
    {
      title: "Audio Visual & Technical Support",
      description:
        "Our team manages advanced audio systems, LED screens, projectors, live streaming, video conferencing, and presentation support to ensure smooth communication throughout your event.",
      icon: faMusic,
    },
    {
      title: "Registration & Guest Management",
      description:
        "From attendee registration and invitations to guest coordination and on-site assistance, we ensure a hassle-free experience for every participant.",
      icon: faBriefcase,
    },
    {
    ...
    },
    {
      ...
      description:
        "We arrange premium hospitality services, catering, accommodation, transportation, and VIP guest management to provide a comfortable and memorable experience.",
      icon: faGlassCheers,
    },
    {
      title: "End-to-End Event Coordination",
      description:
        "Our dedicated event managers oversee every aspect of the meeting, ensuring timelines are met, logistics are coordinated, and your event runs smoothly from start to finish.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const ConferencesSeminarsData = {
  ...
  services: [
    ...
    {
      title: "Speaker & Session Management",
      description:
        "Our team coordinates speaker schedules, presentation requirements, session planning, panel discussions, keynote addresses, and event timelines to ensure a smooth experience for speakers and attendees.",
      icon: faBriefcase,
    },
    {
      title: "Audio Visual & Technology Solutions",
      description:
        "We provide advanced audio systems, LED displays, projectors, live streaming services, video conferencing solutions, and technical support to deliver a world-class event experience.",
      icon: faMusic,
    },
    {
      title: "Registration & Attendee Management",
      description:
        "From online registrations and invitation management to attendee tracking and on-site support, we streamline the entire participant experience.",
      icon: faBriefcase,
    },
    {
      title: "Branding & Event Promotion",
      description:
        "We create impactful event branding, stage designs, promotional materials, digital displays, event signage, and marketing support to maximize event visibility and engagement.",
      icon: faDraftingCompass,
    },
    {
      title: "Hospitality & Logistics Management",
      description:
        "Our team manages accommodation, transportation, catering, VIP guest services, and event logistics to ensure a hassle-free and memorable experience for all participants.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const ProductLaunchEventsData = {
  ...
  introduction: {
    heading:
      "Create Powerful First Impressions with Exceptional Product Launch Events",
    ...
    details:
      "Whether you're launching a new product, service, technology, retail brand, automobile, real estate project, or innovative solution, our expert event management team transforms your vision into an unforgettable experience.",
  },
  servicesTitle: "Product Launch Events Services",
  services: [
    {
      title: "Creative Event Concept & Planning",
      description:
        "Every product deserves a unique introduction. We develop innovative event concepts and strategic launch plans designed to highlight your product's features, benefits, and market value.",
      icon: faBriefcase,
    },
    {
      title: "Venue Selection & Event Setup",
    ...
    {
      title: "Stage Design & Brand Presentation",
      description:
        "We design visually stunning stages, product display areas, launch backdrops, LED displays, digital branding elements, and immersive brand experiences that leave a lasting impression.",
      icon: faDraftingCompass,
    },
    {
      title: "Audio Visual & Technical Production",
      description:
        "Deliver a world-class launch experience with advanced sound systems, LED walls, projection mapping, live streaming, special effects, lighting design, and multimedia presentations.",
      icon: faMusic,
    },
    {
      title: "Product Unveiling Experience",
      description:
        "Create excitement and anticipation with professionally managed product reveal moments, countdown presentations, launch ceremonies, and audience engagement activities.",
      icon: faBriefcase,
    },
    {
      title: "Media & Public Relations Support",
      description:
        "We coordinate media invitations, press conferences, influencer participation, photography, videography, and promotional coverage to maximize your product's reach.",
      icon: faBullhorn,
    },
    {
      title: "Guest Management & Hospitality",
      description:
        "From VIP guest coordination and attendee registration to hospitality services and event logistics, we ensure a seamless experience for every participant.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const AwardFunctionsData = {
  ...
  introduction: {
    ...
    details:
      "Whether it's a corporate awards ceremony, employee recognition program, business excellence awards, educational awards, entertainment awards, or industry recognition event, our team creates exceptional award functions that honor success and leave a lasting impression on every guest.",
  },
  servicesTitle: "Award Functions Services",
  services: [
    {
      title: "Creative Event Concept & Theme Design",
      description:
        "We design unique award function themes, event concepts, and engaging experiences that reflect your organization's values, achievements, and brand identity.",
      icon: faDraftingCompass,
    },
    {
      title: "Venue Selection & Elegant Setup",
      description:
        "From luxury banquet halls to grand convention venues, we help select the perfect location and create a sophisticated atmosphere with premium stage setups and guest seating arrangements.",
      icon: faBriefcase,
    },
    {
    ...
    },
    {
      ...
      description:
        "We provide advanced sound systems, LED walls, dynamic lighting, live streaming, multimedia presentations, and entertainment performances to create an engaging and impactful event experience.",
      icon: faMusic,
    },
    {
      title: "Guest Management & VIP Coordination",
      description:
        "From invitations and registrations to VIP guest handling and hospitality services, we ensure a smooth and comfortable experience for all attendees.",
      icon: faBriefcase,
    },
    {
    ...
    },
    {
      title: "End-to-End Event Coordination",
      description:
        "Our dedicated event managers oversee every detail, ensuring flawless execution from planning to the final award presentation.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const TeamOutingsData = {
  ...
  subtitle:
    "Creating engaging team experiences that strengthen workplace relationships, boost employee morale, and inspire collaboration through memorable corporate outings.",
  coverimage: EventHeroCover,
  ...
  introduction: {
    ...
    details:
      "Whether you're planning a one-day team outing, annual corporate retreat, employee engagement program, leadership getaway, or team-building adventure, we deliver customized experiences that align with your company culture and objectives.",
  },
  servicesTitle: "Corporate Team Outings Services",
  services: [
    {
      title: "Customized Team Outing Planning",
      description:
        "Every organization is unique. We design personalized team outing programs tailored to your goals, team size, budget, and preferred activities.",
      icon: faBriefcase,
    },
    {
      title: "Destination & Venue Selection",
      description:
        "From beach resorts and luxury retreats to adventure parks and nature destinations, we help choose the perfect location that offers relaxation, engagement, and memorable experiences.",
      icon: faBriefcase,
    },
    {
      title: "Team Building Activities",
      description:
        "We organize interactive team-building exercises, leadership challenges, group activities, icebreaker sessions, and fun competitions that strengthen collaboration and communication.",
      icon: faSmile,
    },
    {
      title: "Adventure & Recreational Experiences",
      description:
        "Create excitement with outdoor adventures, sports activities, entertainment programs, cultural experiences, and recreational events designed to energize and engage participants.",
      icon: faBriefcase,
    },
    {
      title: "Travel & Transportation Management",
      description:
        "Our team manages transportation, travel arrangements, accommodation, and logistics to ensure a smooth, hassle-free outing.",
      icon: faBriefcase,
    },
    {
      title: "Food & Hospitality Services",
      description:
        "We provide quality catering, refreshments, hospitality support, and customized dining experiences that enhance employee satisfaction and comfort.",
      icon: faGlassCheers,
    },
    {
      title: "Complete Event Coordination",
      description:
        "From planning and scheduling to on-site management and execution, our dedicated event coordinators ensure every detail is professionally managed.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const AnnualDayCelebrationsData = {
  ...
  introduction: {
    ...
    details:
      "Whether it's a corporate annual day, company anniversary celebration, employee appreciation event, educational institution annual function, or organizational milestone celebration, our expert event planners ensure a memorable and professionally executed experience.",
  },
  servicesTitle: "Annual Day Celebrations Services",
  services: [
    {
      title: "Creative Theme Development",
      description:
        "Every successful celebration starts with a unique concept. Our team develops innovative themes and event experiences that reflect your organization's culture, values, and achievements.",
      icon: faBriefcase,
    },
    {
      title: "Venue Selection & Event Setup",
    ...
    {
      title: "Stage Design & Event Branding",
      description:
        "We create visually impressive stages, LED backdrops, customized branding elements, welcome zones, photo booths, and thematic décor that enhance the event atmosphere.",
      icon: faDraftingCompass,
    },
    {
      title: "Employee Recognition & Award Ceremonies",
      description:
        "Celebrate excellence through professionally organized award presentations, employee recognition programs, achievement ceremonies, and milestone celebrations.",
      icon: faStar,
    },
    {
      title: "Entertainment & Cultural Programs",
      description:
        "Keep your audience engaged with live performances, celebrity appearances, cultural activities, music shows, dance performances, interactive games, and entertainment segments.",
      icon: faSmile,
    },
    {
      title: "Audio Visual & Technical Support",
      description:
        "Our team provides advanced sound systems, LED walls, dynamic lighting, multimedia presentations, live streaming, and event technology solutions to deliver a flawless event experience.",
      icon: faMusic,
    },
    {
      title: "Hospitality & Guest Management",
      description:
        "From invitations and registrations to catering, accommodation, transportation, and VIP guest coordination, we ensure a smooth and enjoyable experience for every attendee.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const EmployeeEngagementEventsData = {
  ...
  introduction: {
    ...
    details:
      "From team-building activities and employee appreciation programs to wellness initiatives, fun-filled celebrations, and corporate engagement events, we design experiences that help organizations connect with their people in memorable ways.",
  },
  servicesTitle: "Employee Engagement Events Services",
  services: [
    {
      title: "Customized Engagement Programs",
      description:
        "Every organization is unique. We create personalized employee engagement events tailored to your company culture, workforce, objectives, and budget.",
      icon: faSmile,
    },
    {
      title: "Team Building Activities",
      description:
        "Strengthen collaboration and communication through interactive team-building games, leadership challenges, problem-solving exercises, and group activities designed to improve teamwork.",
      icon: faSmile,
    },
    {
      title: "Employee Recognition Programs",
      description:
        "Celebrate achievements and reward excellence through employee appreciation events, recognition ceremonies, milestone celebrations, and performance award programs.",
      icon: faBriefcase,
    },
    {
      title: "Corporate Fun & Entertainment Events",
      description:
        "Create memorable experiences with themed events, cultural programs, talent shows, game zones, fun activities, and entertainment sessions that keep employees engaged and energized.",
      icon: faSmile,
    },
    {
      title: "Health & Wellness Programs",
      description:
        "Promote employee well-being through wellness workshops, fitness challenges, mental health awareness sessions, recreational activities, and lifestyle engagement programs.",
      icon: faBriefcase,
    },
    {
      title: "Family Day & Festive Celebrations",
      description:
        "Bring employees and their families together through family day events, festive celebrations, holiday gatherings, annual functions, and community engagement activities.",
      icon: faBriefcase,
    },
    {
      title: "End-to-End Event Management",
      description:
        "From planning and coordination to logistics, venue management, entertainment, hospitality, and execution, our dedicated team ensures a seamless event experience.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const CelebrityManagementData = {
  ...
  services: [
    {
      title: "Celebrity Booking & Coordination",
      description:
        "We help identify and secure the right celebrity, actor, actress, influencer, performer, motivational speaker, or public personality that aligns perfectly with your event objectives and audience.",
      icon: faBriefcase,
    },
    {
      title: "Brand Endorsements & Promotions",
      description:
        "Enhance your brand visibility through celebrity endorsements, promotional appearances, product launches, advertising campaigns, and marketing events that create stronger audience engagement.",
      icon: faBullhorn,
    },
    {
      title: "Corporate Event Celebrity Appearances",
      description:
        "Make your corporate events more impactful with celebrity guest appearances, keynote sessions, award presentations, leadership events, and special performances.",
      icon: faStar,
    },
    {
      title: "Wedding & Private Event Celebrity Management",
      description:
        "Create unforgettable moments with celebrity appearances, live performances, entertainment acts, and exclusive guest experiences for weddings and private celebrations.",
      icon: faBriefcase,
    },
    {
      title: "Influencer & Social Media Collaborations",
      description:
        "Expand your brand reach through influencer marketing campaigns, digital promotions, social media collaborations, and celebrity-driven engagement strategies.",
      icon: faBullhorn,
    },
    {
      title: "Hospitality & Logistics Management",
      description:
        "Our team manages travel arrangements, accommodation, security coordination, hospitality services, backstage management, and all event logistics to ensure a seamless experience.",
      icon: faBriefcase,
    },
    {
      title: "Event-Day Execution & Support",
      description:
        "From arrival coordination and stage appearances to media interactions and performance management, we handle every detail professionally and efficiently.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const LiveConcertsData = {
  ...
  introduction: {
    ...
    details:
      "From music festivals and celebrity concerts to cultural performances, DJ nights, college concerts, and large-scale entertainment events, we transform every show into an extraordinary celebration of music and energy.",
  },
  servicesTitle: "Live Concerts Services",
  services: [
    {
      title: "Concert Planning & Production",
      description:
        "Every successful concert begins with strategic planning. We manage event concepts, production schedules, artist requirements, venue arrangements, and audience experiences to ensure flawless execution.",
      icon: faMusic,
    },
    {
      title: "Artist & Celebrity Coordination",
      description:
        "We work closely with artists, performers, bands, DJs, celebrity guests, and management teams to coordinate schedules, performances, hospitality, and event requirements.",
      icon: faBriefcase,
    },
    {
      title: "Stage Design & Production Setup",
      description:
        "Our creative team designs visually stunning stages, LED walls, lighting setups, special effects, branding elements, and concert environments that enhance the overall experience.",
      icon: faDraftingCompass,
    },
    {
    ...
    {
      title: "Ticketing & Audience Management",
      description:
        "From ticket sales and registration systems to attendee assistance and entry management, we ensure a smooth and organized audience experience.",
      icon: faBriefcase,
    },
    {
      title: "Hospitality & Logistics Support",
      description:
        "Our team manages artist hospitality, transportation, accommodation, backstage operations, catering services, and event logistics for seamless event delivery.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const DjNightsData = {
  ...
  introduction: {
    ...
    details:
      "Whether it's a corporate celebration, college fest, nightclub event, private party, festival, beach party, or large-scale entertainment event, our team transforms every occasion into a vibrant and memorable celebration.",
  },
  servicesTitle: "DJ Nights & Club Events Services",
  services: [
    {
      title: "Event Concept & Theme Development",
      description:
        "Every successful DJ night begins with a unique concept. We design creative themes, event experiences, and entertainment concepts tailored to your audience and event goals.",
      icon: faBriefcase,
    },
    {
    ...
    {
      title: "Stage Design & Visual Production",
      description:
        "Our creative production team develops stunning stage setups, LED walls, dance floors, special effects, branding displays, and immersive event environments that elevate the party experience.",
      icon: faStar,
    },
    {
      title: "Sound, Lighting & Special Effects",
      description:
        "Experience powerful sound systems, intelligent lighting, laser shows, smoke effects, LED visuals, and advanced audio-visual technology that bring the event to life.",
      icon: faMusic,
    },
    {
    ...
    },
    {
      ...
      description:
        "From registrations and ticketing solutions to VIP guest handling and attendee coordination, we manage every aspect of guest experience professionally.",
      icon: faBriefcase,
    },
    {
      title: "Hospitality & Event Logistics",
      description:
        "We handle venue arrangements, artist hospitality, transportation, backstage coordination, catering, and event logistics to ensure flawless execution.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const FashionShowsData = {
  ...
  introduction: {
    ...
    details:
      "From designer collections and brand launches to beauty pageants, modeling events, and luxury fashion showcases, we create visually stunning fashion events that captivate audiences and leave a lasting impression.",
  },
  servicesTitle: "Fashion Shows & Runways Services",
  services: [
    {
      title: "Fashion Show Concept & Planning",
      description:
        "We develop unique event concepts, themes, and creative strategies that align with your brand identity, fashion vision, and target audience.",
      icon: faBriefcase,
    },
    {
      title: "Runway Design & Stage Production",
      description:
        "Our team creates elegant runway setups, designer stages, LED backdrops, lighting concepts, and immersive event environments that elevate the fashion experience.",
      icon: faDraftingCompass,
    },
    {
    ...
    },
    {
      ...
      description:
        "We provide advanced sound systems, dynamic lighting, LED walls, visual effects, multimedia displays, and technical support to create a world-class fashion event atmosphere.",
      icon: faMusic,
    },
    {
      title: "Designer & Brand Showcase",
      description:
        "Highlight your collection with customized branding, product displays, promotional support, and premium presentation experiences designed to maximize visibility.",
      icon: faMusic,
    },
    {
      title: "Celebrity & Influencer Management",
      description:
        "Enhance event impact with celebrity appearances, fashion influencers, brand ambassadors, and media personalities who bring additional excitement and attention to your event.",
      icon: faBriefcase,
    },
    {
      title: "Event Promotion & Media Coverage",
      description:
        "Our team assists with event marketing, media coordination, photography, videography, social media coverage, and press management to maximize audience reach.",
      icon: faBullhorn,
    },
  ],
  finalCTA: {
...
export const CulturalEventsData = {
  ...
  introduction: {
    ...
    details:
      "Whether it's a cultural festival, traditional celebration, college cultural fest, community gathering, government event, music performance, dance competition, or artistic showcase, we create immersive experiences that leave a lasting impact on audiences.",
  },
  ...
  services: [
    {
      title: "Event Concept & Theme Development",
      description:
        "Every cultural event has a unique story to tell. We create engaging event concepts, themes, and experiences that reflect traditions, values, and cultural significance.",
      icon: faBriefcase,
    },
    {
      title: "Stage Design & Event Production",
      description:
        "Our creative team designs visually stunning stages, thematic décor, LED backdrops, cultural installations, and artistic displays that enhance the overall atmosphere of the event.",
      icon: faDraftingCompass,
    },
    {
      title: "Artist & Performer Management",
      description:
        "We coordinate dancers, musicians, singers, folk artists, cultural performers, hosts, and entertainment groups to ensure smooth performances and exceptional audience engagement.",
      icon: faBriefcase,
    },
    {
      title: "Audio Visual & Technical Support",
    ...
    {
      title: "Festival & Community Event Coordination",
      description:
        "Our team manages registrations, scheduling, logistics, crowd management, hospitality, and on-site event coordination to ensure smooth operations throughout the event.",
      icon: faBriefcase,
    },
    {
      title: "Promotions & Media Coverage",
      description:
        "Increase event visibility through digital marketing, social media promotions, photography, videography, media coordination, and event branding solutions.",
      icon: faBullhorn,
    },
    {
      title: "Hospitality & Guest Management",
      description:
        "We provide comprehensive guest management, VIP coordination, accommodation support, transportation arrangements, and hospitality services for participants and attendees.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
  ...
  services: [
    {
      ...
      description:
        "Hackathons, Coding Competitions, Robotics Challenges, Project Exhibitions, Technical Workshops, Innovation Challenges.",
      icon: faBriefcase,
    },
    {
      title: "Management Fests",
      description:
        "Business Plan Competitions, Marketing Challenges, Startup Pitch Events, Group Discussions, Leadership Activities.",
      icon: faBriefcase,
    },
    {
      title: "Entertainment Events",
      description:
        "Celebrity Nights, DJ Nights, Live Music Concerts, Stand-Up Comedy Shows, Influencer Meet & Greet Programs.",
      icon: faSmile,
    },
    {
      title: "Sports & Gaming Events",
      description:
        "Sports Tournaments, E-Sports Competitions, Gaming Challenges, Adventure Activities, Popular college fest attractions often include fashion shows, gaming tournaments, workshops, celebrity performances, DJ nights, and creative competitions., --.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const BrandPromotionsData = {
  ...
  subtitle:
    "Engaging campaigns and activations to boost your brand visibility.",
  ...
  introduction: {
    ...
    details:
      "From BTL activations to guerrilla marketing, we deploy trained promoters and creative setups.",
  },
  servicesTitle: "Brand Promotions Services",
  services: [
    {
      title: "BTL Activations",
      description: "Direct-to-consumer engagement strategies.",
      icon: faBullseye,
    },
    {
      title: "Trained Promoters",
      description: "Providing skilled manpower to represent your brand.",
      icon: faUsers,
    },
    {
      title: "Creative Fabrication",
      description: "Eye-catching promotional kiosks and standees.",
      icon: faDraftingCompass,
    },
  ],
  finalCTA: {
...
export const MallActivationsData = {
  ...
  introduction: {
    heading:
      "Creating Engaging Brand Experiences That Drive Customer Interaction",
  ...
  services: [
    {
      ...
      description:
        "We create strategic activation campaigns that help brands interact directly with their target audience, increase product awareness, and generate meaningful customer engagement.",
      icon: faBullhorn,
    },
    {
      title: "Product Launch Activations",
      description:
        "Introduce new products with exciting mall activations that create buzz, attract attention, and encourage customers to experience your brand firsthand.",
      icon: faBullseye,
    },
    {
      title: "Experiential Marketing Events",
      description:
        "Transform ordinary shopping experiences into memorable brand interactions through creative installations, live demonstrations, interactive zones, and customer engagement activities.",
      icon: faBullhorn,
    },
    {
      title: "Promotional Events & Roadshows",
      description:
        "Drive footfall and increase visibility with promotional activities, contests, giveaways, sampling campaigns, and brand roadshows designed to attract shoppers.",
      icon: faBullhorn,
    },
    {
      title: "Stage Setup & Branding",
      description:
        "Our creative team designs eye-catching activation zones, promotional kiosks, branding displays, LED screens, product showcases, and themed event setups that maximize brand impact.",
      icon: faDraftingCompass,
    },
    {
      title: "Audience Engagement Activities",
      description:
        "We organize games, competitions, interactive experiences, influencer appearances, entertainment programs, and customer participation activities to create excitement and engagement.",
      icon: faSmile,
    },
    {
      title: "End-to-End Event Management",
      description:
        "From permissions and venue coordination to logistics, staffing, promotions, execution, and reporting, we handle every aspect of the activation professionally.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const RoadShowsData = {
  ...
  introduction: {
    ...
    details:
      "Whether you're launching a new product, promoting a brand, conducting awareness campaigns, or expanding market reach, our roadshow management services help you connect with consumers in a memorable and engaging way.",
  },
  ...
  services: [
    {
      ...
      description:
        "Every successful road show begins with a well-planned strategy. We design customized campaigns based on your marketing objectives, target audience, locations, and promotional goals.",
      icon: faBullhorn,
    },
    {
      title: "Mobile Brand Activation",
      description:
        "Bring your brand to life through mobile promotional units, branded vehicles, interactive displays, product demonstrations, and customer engagement activities that attract attention wherever you go.",
      icon: faBullseye,
    },
    {
      title: "Product Launch & Promotional Road Shows",
      description:
        "Generate excitement and awareness for new products and services with professionally managed launch campaigns designed to reach customers directly in high-traffic locations.",
      icon: faBullhorn,
    },
    {
      title: "Experiential Marketing Activities",
      description:
        "Create memorable consumer experiences through live demonstrations, games, contests, sampling campaigns, audience participation activities, and interactive brand engagements.",
      icon: faSmile,
    },
    {
      title: "Event Production & Branding",
      description:
        "We provide complete event production solutions, including branded setups, promotional materials, LED displays, sound systems, stage arrangements, and creative marketing installations.",
      icon: faDraftingCompass,
    },
    {
      title: "Staffing & Brand Promotion Teams",
      description:
        "Our trained promoters, hosts, emcees, and event coordinators effectively represent your brand and engage audiences throughout the campaign.",
      icon: faUsers,
    },
    {
      title: "Logistics & Route Management",
      description:
        "From transportation planning and permissions to equipment management and venue coordination, we ensure smooth operations across all campaign locations.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const StoreLaunchesData = {
  ...
  introduction: {
    heading:
      "Creating Grand Store Openings That Drive Attention & Business Growth",
    ...
    details:
      "Whether you're launching a retail store, franchise outlet, showroom, boutique, supermarket, luxury brand store, or commercial establishment, our expert event management team ensures a successful and impactful launch.",
  },
  servicesTitle: "Store Launches Services",
  services: [
    {
      title: "Store Launch Strategy & Planning",
      description:
        "Every successful launch starts with a clear vision. We create customized launch strategies based on your brand identity, target audience, location, and business objectives.",
      icon: faStore,
    },
    {
      title: "Grand Opening Ceremonies",
      description:
        "From ribbon-cutting ceremonies and inaugural events to VIP launches and media gatherings, we organize memorable opening experiences that attract attention and create excitement.",
      icon: faScroll,
    },
    {
      title: "Brand Activation & Customer Engagement",
      description:
        "We design interactive experiences, product showcases, promotional activities, contests, giveaways, and customer engagement programs that encourage participation and boost brand awareness.",
      icon: faSmile,
    },
    {
      title: "Store Branding & Event Setup",
      description:
        "Our team creates eye-catching store decorations, entrance arches, promotional displays, LED screens, branded installations, and launch-day visuals that enhance the customer experience.",
      icon: faDraftingCompass,
    },
    {
      title: "Celebrity & Influencer Engagement",
      description:
        "Increase visibility and audience reach with celebrity appearances, influencer collaborations, guest speakers, and brand ambassadors who help create greater excitement around your launch.",
      icon: faStar,
    },
    {
      title: "Marketing & Promotional Campaigns",
      description:
        "We support your launch through digital promotions, social media campaigns, outdoor advertising, event branding, and media coordination to maximize exposure.",
      icon: faBullhorn,
    },
    {
      title: "Hospitality & Guest Management",
  ...
  services: [
    {
      ...
      description:
        "Our team develops customized event plans based on audience size, venue requirements, campaign objectives, and logistical needs to ensure a successful event experience.",
      icon: faBriefcase,
    },
    {
      title: "Stage Design & Event Production",
    ...
    },
    {
      title: "Audio Visual & Technical Support",
      description:
        "Deliver your message clearly with advanced sound systems, LED screens, live streaming solutions, lighting setups, video production, and technical event management.",
      icon: faMusic,
    },
    {
      title: "Public Meeting & Rally Management",
      description:
        "From venue preparation and crowd flow planning to on-site coordination and event supervision, we ensure smooth management of public gatherings and outreach events.",
      icon: faBriefcase,
    },
    {
    ...
    {
      title: "Guest & Media Coordination",
      description:
        "Our team manages guest arrivals, VIP coordination, media support, registration processes, and event-day logistics for a seamless experience.",
      icon: faBriefcase,
    },
    {
      title: "Logistics & Operational Management",
      description:
        "From transportation planning and permissions coordination to equipment management and venue operations, we oversee every detail of event execution.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
  ...
  services: [
    {
      ...
      description:
        "Every successful PR event starts with a clear objective. We work closely with clients to develop customized event strategies that align with business goals, communication priorities, and audience expectations.",
      icon: faBriefcase,
    },
    {
    ...
    {
      title: "Brand Awareness & Public Engagement Programs",
      description:
        "Our team designs engaging public relations campaigns, community outreach programs, promotional activities, and awareness initiatives that strengthen brand reputation and audience trust.",
      icon: faSmile,
    },
    {
    ...
    {
      title: "Media Coordination & Guest Management",
      description:
        "We handle media invitations, journalist coordination, VIP guest management, registrations, hospitality services, and event-day support to ensure seamless event execution.",
      icon: faBriefcase,
    },
    {
      title: "Audio Visual & Technical Support",
      description:
        "Our technical solutions include sound systems, LED walls, presentation equipment, live streaming, lighting setups, and multimedia production services that enhance audience engagement.",
      icon: faMusic,
    },
    {
...
export const ExhibitionStallDesignData = {
  ...
  introduction: {
    ...
    details:
      "Whether you're launching a product, promoting a brand, participating in a trade fair, or showcasing your services, our custom-designed exhibition stalls help your business stand out from the crowd.",
  },
  servicesTitle: "Exhibition Stall Design Services",
  services: [
    {
      title: "Custom Stall Design & Concept Development",
      description:
        "Every brand has a unique story. We create customized exhibition stall concepts that reflect your brand identity, marketing objectives, and audience engagement goals.",
      icon: faDraftingCompass,
    },
    {
      title: "Creative 3D Stall Visualization",
      description:
        "Before construction begins, we provide realistic 3D stall designs and visual concepts, allowing you to experience your exhibition space and make informed design decisions.",
      icon: faStar,
    },
    {
      title: "Modular & Custom-Built Exhibition Stalls",
      description:
        "Whether you need a compact modular setup or a large custom-built exhibition pavilion, we design and fabricate stalls that combine aesthetics, functionality, and visitor engagement.",
      icon: faBriefcase,
    },
    {
      title: "Branding & Visual Communication",
      description:
        "Our design team integrates impactful branding elements, graphics, LED displays, digital screens, product showcases, and interactive features to enhance brand visibility and recognition.",
      icon: faStar,
    },
    {
      title: "Fabrication & Installation",
      description:
        "We handle complete stall production, fabrication, transportation, installation, dismantling, and venue coordination to ensure a hassle-free exhibition experience.",
      icon: faDraftingCompass,
    },
    {
      title: "Interactive Engagement Solutions",
      description:
        "Create memorable visitor experiences with product demonstration zones, touch-screen displays, interactive kiosks, virtual experiences, and experiential marketing elements.",
      icon: faSmile,
    },
    {
      title: "Exhibition Support & On-Site Management",
      description:
        "Our dedicated team provides technical assistance, maintenance support, logistics management, and on-site coordination throughout the event.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const TradeShowManagementData = {
  ...
  services: [
    {
      title: "Strategic Trade Show Planning",
      description:
        "Every successful trade show starts with a well-defined strategy. We work closely with clients to understand their goals, target audience, and industry requirements to create a customized event plan.",
      icon: faBriefcase,
    },
    {
      title: "Exhibition Booth Design & Setup",
      description:
        "Our creative team designs visually appealing exhibition booths that effectively showcase your brand, products, and services while maximizing visitor engagement and interaction.",
      icon: faDraftingCompass,
    },
    {
      title: "Branding & Visual Communication",
      description:
        "We integrate impactful branding elements, LED displays, digital presentations, promotional materials, product displays, and interactive experiences that enhance brand visibility and attract potential customers.",
      icon: faStar,
    },
    {
      title: "Product Demonstrations & Engagement Activities",
      description:
        "Create meaningful visitor interactions through live demonstrations, experiential marketing activities, product launches, presentations, and interactive engagement zones.",
      icon: faSmile,
    },
    {
      title: "Logistics & Event Coordination",
      description:
        "From transportation and venue coordination to installation, dismantling, and equipment management, we handle every logistical aspect of your trade show participation.",
      icon: faBriefcase,
    },
    {
      title: "Lead Generation & Visitor Engagement",
      description:
        "Our trade show solutions are designed to increase footfall, encourage meaningful conversations, capture quality leads, and strengthen customer relationships.",
      icon: faSmile,
    },
    {
      title: "Technical Support & On-Site Management",
      description:
        "We provide complete technical assistance, event supervision, audio-visual support, and dedicated on-site coordination to ensure a seamless event experience.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const ExpoPromotionsData = {
  ...
  services: [
    {
      title: "Strategic Expo Marketing Planning",
      description:
        "Every successful expo campaign begins with a strong strategy. We develop customized promotional plans based on your business goals, target audience, industry, and event objectives.",
      icon: faBullhorn,
    },
    {
      title: "Brand Activation Campaigns",
      description:
        "Create memorable experiences through interactive brand activations, experiential marketing activities, product demonstrations, contests, and audience engagement programs that encourage participation.",
      icon: faBullhorn,
    },
    {
      title: "Exhibition Booth Promotions",
      description:
        "Attract more visitors with engaging booth activities, promotional displays, live presentations, product showcases, and creative marketing concepts that increase footfall and engagement.",
      icon: faBullhorn,
    },
    {
      title: "Product Launch & Showcase Promotions",
      description:
        "Generate excitement around new products and services through professionally managed launch campaigns, demonstrations, sampling activities, and promotional events.",
      icon: faMusic,
    },
    {
      title: "Influencer & Celebrity Engagement",
      description:
        "Increase visibility and audience interest through influencer collaborations, celebrity appearances, brand ambassadors, and promotional personalities that strengthen brand credibility.",
      icon: faStar,
    },
    {
      title: "Lead Generation Campaigns",
      description:
        "Our expo promotion strategies are designed to capture quality leads, encourage meaningful interactions, and create opportunities for long-term customer relationships.",
      icon: faBullhorn,
    },
    {
...
export const PoojaEventsData = {
  ...
  services: [
    {
      title: "Traditional Event Planning",
      description:
        "Every pooja has unique customs and requirements. We carefully plan and coordinate every aspect of the ceremony according to your traditions and preferences.",
      icon: faScroll,
    },
    {
      title: "Venue Decoration & Setup",
      description:
        "Our team creates beautiful and traditional décor arrangements, including floral decorations, pooja mandap setups, entrance decorations, seating arrangements, and spiritual ambiance enhancements.",
      icon: faBriefcase,
    },
    {
      title: "Pooja Arrangements & Ritual Support",
      description:
        "We assist in organizing pooja materials, ritual essentials, seating arrangements, and ceremony logistics to ensure everything is prepared for a smooth and sacred experience.",
      icon: faPrayingHands,
    },
    {
      title: "Floral Decoration Services",
      description:
        "Enhance the spiritual atmosphere with fresh flower decorations, traditional garlands, rangoli designs, floral backdrops, and customized ceremonial décor.",
      icon: faDraftingCompass,
    },
    {
      title: "Guest Management & Hospitality",
      description:
        "From invitations and guest coordination to refreshments, seating arrangements, and hospitality services, we ensure a comfortable experience for all attendees.",
      icon: faBriefcase,
    },
    {
      title: "Audio & Event Support",
      description:
        "We provide sound systems, microphones, devotional music arrangements, LED displays (if required), and technical support for larger religious gatherings.",
      icon: faMusic,
    },
    {
      title: "Photography & Videography",
...
export const TempleFestivalsData = {
  ...
  services: [
    {
      title: "Festival Planning & Coordination",
      description:
        "Every temple festival is unique. Our team works closely with temple committees and organizers to plan schedules, rituals, logistics, and event activities according to traditional practices.",
      icon: faBriefcase,
    },
    {
      title: "Temple Decoration & Floral Arrangements",
      description:
        "Create a divine atmosphere with elegant floral decorations, traditional lighting, entrance arches, ceremonial pathways, and beautifully designed festival décor.",
      icon: faDraftingCompass,
    },
    {
      title: "Religious Processions & Cultural Events",
      description:
        "We organize temple processions, devotional programs, cultural performances, spiritual gatherings, and community celebrations that enhance the festival experience.",
      icon: faScroll,
    },
    {
      title: "Stage Setup & Event Infrastructure",
      description:
        "Our team provides stages, seating arrangements, barricades, lighting systems, LED displays, public address systems, and event infrastructure required for large gatherings.",
      icon: faDraftingCompass,
    },
    {
    ...
    },
    {
      title: "Crowd Management & Security",
      description:
        "We implement organized crowd control measures, security coordination, entry management, and emergency support to ensure the safety and comfort of devotees.",
      icon: faBriefcase,
    },
    {
      title: "Hospitality & Volunteer Coordination",
      description:
        "From guest management and volunteer support to food distribution arrangements and accommodation assistance, we ensure smooth event operations throughout the festival.",
      icon: faBriefcase,
    },
  ],
  finalCTA: {
...
export const TraditionalCeremoniesData = {
  ...
  services: [
    {
      title: "Personalized Ceremony Planning",
      description:
        "Every tradition is unique. Our team works closely with families to understand customs, rituals, and preferences, ensuring that every ceremony is planned according to cultural values and traditions.",
      icon: faScroll,
    },
    {
      title: "Traditional Venue Decoration",
      description:
        "Create a warm and festive atmosphere with beautifully designed décor, floral arrangements, traditional backdrops, entrance decorations, lighting setups, and ceremonial seating arrangements.",
      icon: faBriefcase,
    },
    {
      title: "Ritual & Event Coordination",
      description:
        "We assist in organizing ceremony schedules, ritual arrangements, guest coordination, and event logistics to ensure smooth execution from beginning to end.",
      icon: faBriefcase,
    },
    {
      title: "Floral & Theme Decorations",
      description:
        "Enhance the beauty of your event with fresh flower decorations, traditional mandap setups, rangoli designs, cultural décor elements, and customized ceremonial themes.",
      icon: faDraftingCompass,
    },
    {
      title: "Guest Management & Hospitality",
      description:
        "From invitation coordination and guest assistance to seating arrangements, catering support, and hospitality services, we ensure a comfortable and welcoming experience for everyone.",
      icon: faBriefcase,
    },
    {
    ...
    },
    {
      title: "Entertainment & Cultural Programs",
      description:
        "We can arrange traditional music performances, cultural activities, devotional programs, and entertainment elements that complement the spirit of the ceremony.",
      icon: faSmile,
    },
  ],
  finalCTA: {
