          ...
          {eventTypes.map((type) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-lg md:text-xl font-semibold">{type}</span>
      ...
      component: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto p-8 rounded-3xl bg-black/30 backdrop-blur-md border border-white/10">
          <div className="space-y-4 text-left">
            <label className="block text-base md:text-lg font-medium text-white/90">Event Date (Approximate)</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/10 border-2 border-white/20 focus:border-primary outline-none transition-colors text-sm md:text-base text-white"
              />
            </div>
          </div>
          <div className="space-y-4 text-left">
            <label className="block text-base md:text-lg font-medium text-white/90">Location / Venue</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/10 border-2 border-white/20 focus:border-primary outline-none transition-colors text-sm md:text-base text-white placeholder:text-white/40"
              />
            </div>
          </div>
          <div className="space-y-4 text-left md:col-span-2">
            <label className="block text-base md:text-lg font-medium text-white/90">Estimated Guest Count</label>
            <div className="relative">
      ...
      component: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl mx-auto">
          {budgetRanges.map((range) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-lg md:text-xl font-semibold">{range}</span>
    ...
    },
    {
      ...
      component: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto p-8 rounded-3xl bg-black/40 backdrop-blur-md border border-white/10">
          <div className="space-y-4 text-left">
            <label className="block text-base md:text-lg font-medium text-white/90">Full Name</label>
            <div className="relative">
          ...
          <div className="space-y-4 text-left">
            <label className="block text-base md:text-lg font-medium text-white/90">Phone Number</label>
            <div className="relative">
          ...
          <div className="space-y-4 text-left md:col-span-2">
            <label className="block text-base md:text-lg font-medium text-white/90">Email Address</label>
            <div className="relative">
          ...
          <div className="space-y-4 text-left md:col-span-2">
            <label className="block text-base md:text-lg font-medium text-white/90">Any Additional Details?</label>
            <textarea
              placeholder="Tell us more about your specific requirements..."
              rows="4"
              value={formData.message}
              onChange={(e) => handleInputChange("message", e.target.value)}
              className="w-full p-4 rounded-xl bg-white/10 border-2 border-white/20 focus:border-primary outline-none transition-colors text-sm md:text-base text-white placeholder:text-white/40 resize-none"
            />
          </div>
        </div>
      )
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="text-center max-w-xl">
          ...
          <h2 className="text-[26px] md:text-[38px] lg:text-5xl font-bold text-gray-900 mb-4">Thank You!</h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-8 relative z-10">
        <div className="w-full max-w-5xl mx-auto">
          ...
          {currentStep > 0 && (
            <button
              onClick={prevStep}
              className="mb-8 flex items-center text-white/70 hover:text-primary transition-colors font-medium text-base md:text-lg group"
            >
          ...
          <div className="text-center mb-12 animate-fadeIn">
            ...
            <h1 className="text-[28px] md:text-5xl lg:text-[52px] font-bold text-white mb-4 px-4 drop-shadow-lg">
              {steps[currentStep].question}
            </h1>
            <p className="text-base md:text-lg text-white/80 px-4 max-w-2xl mx-auto">
          ...
          <div className="mt-12 flex justify-center gap-4">
            {currentStep === steps.length - 1 ? (
              <button
                ...
                disabled={loading}
                className="px-12 py-5 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-all shadow-xl text-lg md:text-xl flex items-center gap-3 transform hover:scale-105 active:scale-95 disabled:bg-gray-400"
              >
              ...
              (currentStep === 1) && (
                <button
                  onClick={nextStep}
                  className="px-12 py-5 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-all shadow-xl text-lg md:text-xl flex items-center gap-3 transform hover:scale-105 active:scale-95"
                >
                  Continue
                  <FaArrowRight />
                </button>
