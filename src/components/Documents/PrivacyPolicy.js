  ...
  return (
    <>
      ...
      <div className="privacypoliocy px-5 text-black mx-4">
        <h1 className="text-center py-10 font-bold text-black pt-20">
          {" "}
          PRIVACY POLICY
        </h1>
        ...
        <br />
        <br />
        <h2 className="font-medium text-black">2. Definitions</h2>
        <br />
        ...
        <br />
        <br />
        <h2 className="font-medium text-black">5. Use of Data</h2>
        <br />
        ...
        <br />
        <br />
        <h2 className="font-medium text-black">14. Analytics</h2>
        <br />
        We may use third-party Service Providers to monitor and analyze the use
        of our Service.
        <br />
        <br />
        <h2 className="font-medium text-black">15. CI/CD tools</h2>
        <br />
        ...
        <br />
        <br />
        <h2 className="font-medium text-black">17. Payments</h2>
        <br />
        ...
        <br />
        <br />
        <h2 className="font-medium text-black">21. Contact Us</h2>
        <br />
