...
const ReturnsPolicy = () => {
  return (
    ...
    <h1 className="text-[28px] md:text-[45px] text-center py-10 font-bold"> Cancellation & Refund Policy </h1>
Last updated: 2022-11-01<br/><br/>
<p className="text-[14px] md:text-[18px] font-medium">Leor Media (CSD) believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p><br />
