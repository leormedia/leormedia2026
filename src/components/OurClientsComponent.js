        ...
        <section className="py-20 bg-gray-50/50 overflow-hidden border-y border-gray-100">
            <div className="container mx-auto px-4 mb-16">
                <div className="text-center">
                    <span className="text-primary font-bold tracking-[0.2em] uppercase text-xs mb-3 block">TRUSTED BY INDUSTRY LEADERS</span>
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Our Clients</h2>
