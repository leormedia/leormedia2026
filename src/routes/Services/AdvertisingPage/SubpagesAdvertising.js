              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-6">
                {(data.hero?.ctas || [
                  ...
                  <Link
                    ...
                    className={`w-full md:w-auto px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 flex items-center justify-center gap-2 ${cta.primary
