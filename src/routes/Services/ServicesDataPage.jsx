...
export const ServicesPageDetails = {
  ...
  title:"Services",
  subtitle:"Leor Media is your reliable partner for innovative, scalable, and high-performance web development solutions.",
  coverImage: {
  ...
  section2: {
    ...
    description:"At Leor Media, we specialize in building robust, secure, and scalable web applications aligned with your business objectives.",
  },
  services: [
    {
