      ...
      <main className="space-y-8 my-6">
        ...
        >
          <div className="text-center text-white max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link
                to="/contactus"
                className="inline-flex items-center bg-white text-black px-4 py-2 rounded-md  font-medium hover:bg-gray-100 transition-colors"
              >
        ...
        <section className="px-4">
          <div className="text-center mb-8">
            ...
            <h2 className="font-bold bg-gradient-to-r from-yellow-400 to-orange-600 bg-clip-text text-transparent mb-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {AdvertisingCompany.services.map((service, index) => (
              ...
              >
                ...
                <Link
                  to={service.link}
                  className="inline-flex items-center justify-center w-full bg-primary text-white px-2 py-1 rounded  font-medium hover:bg-orange-500 transition-colors"
                >
        ...
        <section className="px-4 py-12 bg-white mx-4 my-8 rounded-xl shadow-sm border border-gray-100">
          <div className="max-w-5xl mx-auto space-y-12 text-gray-800">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="font-bold text-primary mb-6">Grow Your Brand with Powerful Advertising</h2>
            ...
            <div>
              <h2 className="font-bold text-center mb-8 border-b pb-4">Our Advertisement Services</h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1">
                  <h3 className="font-bold mb-3 text-gray-800">Digital Advertising</h3>
                  <p className="mb-4 text-gray-600">Reach your audience online through high-performing digital campaigns.</p>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1">
                  <h3 className="font-bold mb-3 text-gray-800">Lead Generation Campaigns</h3>
                  <p className="text-gray-600">We create targeted campaigns that help businesses attract quality customers and improve conversions.</p>
                </div>

                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1">
                  <h3 className="font-bold mb-3 text-gray-800">Outdoor Advertising</h3>
                  <p className="mb-4 text-gray-600">Make your brand visible everywhere with impactful outdoor promotions.</p>
                  <ul className="list-disc pl-5  space-y-2 text-gray-700 font-medium">
                  ...
                  <p className="mt-4 text-gray-500 italic">Our outdoor advertising solutions help your business gain strong local visibility and brand recognition.</p>
                </div>

                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1">
                  <h3 className="font-bold mb-3 text-gray-800">Print Advertising</h3>
                  <p className="mb-4 text-gray-600">Professional print advertising solutions that create lasting impressions.</p>
                  <ul className="list-disc pl-5  space-y-2 text-gray-700 font-medium">
                    <li>Newspaper Ads</li>
                  ...
                  <p className="mt-4 text-gray-500 italic">We design attractive and informative print materials that effectively communicate your brand message.</p>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 md:col-span-2">
                  <h3 className="font-bold mb-3 text-gray-800">Branding & Promotional Campaigns</h3>
                  <p className="mb-4 text-gray-600">Creative promotional strategies to increase customer engagement.</p>
                  ...
                  <p className="mt-4 text-gray-500 italic">We combine creativity and strategy to make your brand stand out in the market.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-50/50 p-8 rounded-2xl">
              <h2 className="font-bold text-center mb-8">Why Choose Leor Media?</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-bold text-primary mb-2">Creative Advertising Strategies</h4>
                  <p className="text-gray-600">We create campaigns that are visually attractive, engaging, and result-oriented.</p>
                </div>
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-bold text-primary mb-2">Targeted Audience Reach</h4>
                  <p className="text-gray-600">Our advertising solutions focus on reaching the right people at the right time.</p>
                </div>
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-bold text-primary mb-2">Affordable & Effective</h4>
                  <p className="text-gray-600">We provide cost-effective advertising services without compromising quality.</p>
                </div>
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-bold text-primary mb-2">End-to-End Support</h4>
                  <p className="text-gray-600">From planning and design to execution and monitoring, we handle everything.</p>
                </div>
                <div className="bg-white p-5 rounded-lg shadow-sm md:col-span-2 lg:col-span-2">
                  <h4 className="font-bold text-primary mb-2">Result-Driven Approach</h4>
                  <p className="text-gray-600">Our focus is not just visibility but real business growth and customer engagement.</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <h2 className="font-bold mb-6">Industries We Serve</h2>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {["Real Estate","Restaurants & Cafes","Fashion & Retail","Education Institutes","Healthcare Businesses","Corporate Companies","Events & Entertainment","Startups & Local Businesses"].map((industry, index) => (
                  <span key={index} className="bg-white border border-gray-200 text-gray-800 px-5 py-2.5 rounded-full  font-semibold shadow-sm hover:border-primary hover:text-primary transition-colors cursor-default">
                    {industry}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-primary to-orange-600 p-8 md:p-12 rounded-2xl text-center text-white shadow-lg">
              <h2 className="font-bold mb-4 text-white">Let’s Promote Your Brand</h2>
              ...
              <div className="flex flex-col items-center justify-center gap-4">
                <p className="font-semibold text-yellow-300">📞 Contact Us Today</p>
